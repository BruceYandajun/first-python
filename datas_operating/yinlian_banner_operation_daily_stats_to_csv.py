...
id_list = ["dfld", "dfld", "abcd"]
order_list = ["1", "2", "3"]
code_list = ["abc", "def", "ddd"]
name_list = ["food", "ai", "web"]
...
for day in day_list:
    ...
    for i in range(0, random.randint(100 * amount_unit, 200 * amount_unit)):
        data = {
            ...
            "bannerId": [random.choice(id_list)],
            "bannerOrder": [random.choice(order_list)],
            "bannerCode": [random.choice(code_list)],
            "clicksNum": [random.randint(0, 4)],
            "showsNum": [random.randint(5, 10)],
            "bannerName": [random.choice(name_list)]
        }
